...
** Note that this is the backend for the tetris project hosted at https://github.com/clheard54/Mod-3-Tetris-Frontend/. 
 ...
 ```
   git clone <example: git@github.com:.../Tetris-Backend.git></example:>
  ```
  - Back in your terminal, and from the main directory for this project, type "bundle install".
  ```
   bundle install
  ```
 - Then, again from the root directory, run "rake db:create" and "rake:db:migrate" to create the database locally.
  ```
...
- You'll also need to fork and clone down the <a href="https://github.com/clheard54/Mod-3-Tetris-Frontend/">frontend</a> repo for this project. You can find the link here: https://github.com/clheard54/Mod-3-Tetris-Frontend/. Follow the same steps as above.
